...
class PastesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paste" do
    assert_difference('Paste.count') do
      post pastes_url, params: { paste: { content: @paste.content, language: @paste.language, name: @paste.name, owner: @paste.owner, private: @paste.private } }
    end
  ...
  test "should update paste" do
    patch paste_url(@paste), params: { paste: { content: @paste.content, language: @paste.language, name: @paste.name, owner: @paste.owner, private: @paste.private } }
